...
export default function BiryaniProcedure() {
    const steps = [
        ...
        '6. Add deried plums,potatoes and chicken.Cook for 3-4 minutes on high heat.Add 1/2 litres og water and cook until almost thickened but still slightly thin consistency',
        '7. Put big pot of water on high heat when starts boiling and add star anise,cinnamon sticks,bay leaves',
        '8. Once water is fully boiled add soaked water and cook until 70% ,drain and layer on top of gravy .',
            ...
            <ScrollView style={{ flex: 1, backgroundColor: '#fff' }} contentContainerStyle={{ paddingBottom: 20 }}>
                ...
                <View style={styles.videoWidgetContainer}>
                    ...
                    resizeMode='cover' isLooping useNativeControls shouldPlay
                     ...
                     <TouchableOpacity style={styles.menuButton}><Entypo name="dots-three-horizontal" size={14} /></TouchableOpacity>
                    ...
                    <View style={styles.bookMark}>
                        <TouchableOpacity> <FontAwesome name="bookmark-o" size={18} /></TouchableOpacity></View>
                ...
                <View style={styles.detailBox}>
                    ...
                    <View style={styles.tabBox}>
                        ...
                        <TouchableOpacity style={styles.inactiveTab} onPress={(Recipe1)}><Text style={styles.inactiveTabText}>Ingridents</Text></TouchableOpacity>
                        <TouchableOpacity style={styles.activeTab}><Text style={styles.activeTabText}>Procedure</Text></TouchableOpacity>
                    </View>
                    {/* {serve and items} */}
