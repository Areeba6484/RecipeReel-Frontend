...
export default function BiryaniScreen() {
            ...
            <ScrollView style={{ flex: 1, backgroundColor: '#fff' }} contentContainerStyle={{ paddingBottom: 20 }}>
                ...
                <View style={styles.detailBox}>
                    ...
                    <View style={styles.tabBox}>
                        ...
                        <TouchableOpacity style={styles.activeTab}><Text style={styles.activeTabText}>Ingridents</Text></TouchableOpacity>
                        <TouchableOpacity style={styles.inactiveTab} onPress={(Procedure)}><Text style={styles.inactiveTabText}>Procedure</Text></TouchableOpacity>
                    </View>
                    {/* {serve and items} */}
                    ...
                    {[
                        ...
                        { name: 'Tomatoes (choped)', qty: '2 medium' },
                        ...
                        <View key={index} style={styles.ingredientItem}>
                            {/* <IconLib name={item.icon} size={22} color="#333"/> */}
